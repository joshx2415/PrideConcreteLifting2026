<template>
  ...
  >
    ...
    <div class="flex flex-col items-center w-full pt-4 space-y-4">
      <div v-if="errors.length" class="w-full p-4 text-pride-red bg-red-50 border border-red-200 rounded-lg" role="alert" aria-live="assertive">
      ...
      <button type="submit" name="button" :disabled="isSubmitting" :aria-busy="isSubmitting"
