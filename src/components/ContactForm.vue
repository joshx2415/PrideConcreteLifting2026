<template>
  <div class="w-full max-w-4xl mx-auto bg-white rounded-xl shadow-2xl overflow-hidden transition duration-500 ease-in-out transform">
    <div v-if="isSuccess" class="flex flex-col w-full p-16 text-center" role="alert" aria-live="assertive">
      <h3 class="mb-4 text-3xl font-bold text-navy-900">Contact Form Submitted!</h3>
      <p class="text-xl text-gray-600">Thank you for reaching out to us - we will contact you as soon as we are able.</p>
    </div>
    ...
    <form
      ...
      class="flex flex-col w-full p-10 px-8 pt-8 pb-8"
      novalidate
    >
      ...
      <div class="flex flex-wrap mb-6 -mx-3">
        <div class="w-full px-3">
          <label class="block mb-2 text-lg font-semibold text-navy-900" for="email">
            Email <span class="text-pride-red" aria-hidden="true">*</span>
          </label>
          <input
            class="form-input w-full px-4 py-3 text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pride-red focus:border-transparent"
      ...
      <div class="flex flex-wrap mb-6 -mx-3">
        <div class="w-full px-3">
          <label class="block mb-2 text-lg font-semibold text-navy-900" for="message">
            Message <span class="text-pride-red" aria-hidden="true">*</span>
          </label>
          <textarea
            ...
            id="message" type="text" name="message" v-model="formData.message" placeholder="Your Message..."
            required=""></textarea>
        </div>
      </div>

      <div class="flex flex-col items-center w-full pt-4 space-y-4" aria-live="polite">
        ...
        <div v-if="submitError" class="w-full p-4 text-pride-red bg-red-50 border border-red-200 rounded-lg" role="alert">
          <p class="font-semibold">Something went wrong. Please try again later.</p>
        ...
        >
          ...
          <svg v-else xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 512 512" fill="currentColor" aria-hidden="true">
