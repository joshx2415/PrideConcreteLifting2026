<template>
  ...
  >
    ...
    <div class="flex flex-col items-center w-full pt-4 space-y-4">
      <div v-if="errors.length" role="alert" class="w-full p-4 text-pride-red bg-red-50 border border-red-200 rounded-lg">
      ...
      <button type="submit" name="button" :disabled="isSubmitting" :aria-busy="isSubmitting"
        ...
        <svg v-else xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="w-5 h-5" viewBox="0 0 512 512" fill="currentColor">
